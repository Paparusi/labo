...
import { Bell, CheckCheck, CheckCircle2, XCircle, AlertTriangle, MessageSquare, Users, Trash2, Settings } from 'lucide-react'
...
const TYPE_LABELS: Record<string, string> = {
  new_application: 'Ứng viên',
  application_received: 'Ứng viên',
  trial_expiring: 'Gói dịch vụ',
...
function getNotificationHref(n: Notification): string | null {
  ...
  switch (n.type) {
    ...
    case 'application_received':
      return data?.job_id ? `/factory/jobs/${data.job_id}` : '/factory/jobs'
    case 'trial_expiring':
      return '/factory/subscription'
    case 'new_message':
      return data?.conversation_id ? `/factory/messages/${data.conversation_id}` : '/factory/messages'
    default:
      return null
  }
}
      ...
      <div className="container mx-auto px-4 py-6 max-w-2xl animate-fade-in-up">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="ghost" size="sm" onClick={() => router.push('/factory/settings')}>
